...
![Figure 4. Workflow of methods](sRNA_examples.png)
...
This seach gave an output for each genome containing coordinates (contig, start, end, strand) for the location of sequences matching Rfam families. These files needed to be combined and reformatted so that the nucelotide sequences of the matches could be obtained. This was done for each group:
...
![Figure a. show the clade](sRNA_examples.png)
