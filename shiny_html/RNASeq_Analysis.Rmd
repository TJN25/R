...
* [_compare\_ncRNA.R_](#section-compare_ncrna.r) _-r \<GFF 1\> -g \<GFF 2\> -a \<Aligment File\> -x \<File ID 1\> -y \<File ID 2\>  -s \<Alignment position for File 1\> -t \<Alignment position for File 2\>  -o \<Output Name\>_
