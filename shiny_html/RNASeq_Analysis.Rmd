...
genera <- c("Escherichia", "Shigella", "Salmonella", "Enterobacter", "Klebsiella", "Serratia")
...
escherichiaMerged <- read.table("~/phd/RNASeq/combined_gff_files/version_4/lysobacter-pseudomonas_merged.gff", sep = "\t", header = T, fill = T)
