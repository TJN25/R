...
```{r tree_viewer_app, echo=FALSE, include=T, eval=T}
...
selectInput(
              ...
              choices = c("All" = "~/phd/RNASeq/alignments/all_alignments/all.guide_tree", 
...
selectInput(
              ...
              choices = c("-",
                          "All" = "~/phd/RNASeq/alignments/all_alignments/all", 
...
renderDataTable({
  if(!is.null(input$upload_file)){ 
   dat <- read.table(input$upload_file$datapath, sep = "\t", header = T, as.is = T)
   renderDataTable({
