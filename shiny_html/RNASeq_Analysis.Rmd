...
```{r escherichia_merging_analysis}
...
```{r escherichia-shigella_merging_analysis}
...
```{r conservation_info_escherichia_test}
escherichiaMerged <- read.table("~/phd/RNASeq/combined_gff_files/escherichia_merged.gff", sep = "\t", header = T, fill = T)
...
```{r conservation_esch-shigella}
escherichiaMerged <- read.table("~/phd/RNASeq/combined_gff_files/escherichia-shigella-salmonella_merged.gff", sep = "\t", header = T, fill = T, as.is = T)
