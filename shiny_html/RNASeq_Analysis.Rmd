...
file_path <- "~/phd/RNASeq/combined_gff_files/"
combinedList <- list()
...
file_path <- "~/phd/RNASeq/combined_gff_files_random/"
...
combined_sRNAs <-combinedList[["escherichia-shigella-salmonella-enterobacter-klebsiella-serratia_merged.gff"]]$number_of_features

combined_random <-combinedListRandom[["escherichia-shigella-salmonella-enterobacter-klebsiella-serratia_merged.gff"]]$number_of_features
...
```{r conservation_of_sRNAs, eval = F}
...
if(random){
  ...
  filePath <- "~/phd/RNASeq/combined_gff_files/version_5/"
}
...
resDat <- data.frame(id = NA,
                     ...
                     order.prop = NA,
                     file.name = NA,
                     category = NA, stringsAsFactors = F)
...
for(i in names(resList)){
  print(i)
  summary <- resDat %>% filter(category == i) %>% 
