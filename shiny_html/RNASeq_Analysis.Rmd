...
if(random){
  filePath <- "~/phd/RNASeq/combined_gff_files_random/version_5/"
}else{
...
ggplot() +
  geom_freqpoly(data = resDatReal, aes(x = as.numeric(score)), binwidth = 0.05, colour = "blue")+
  geom_freqpoly(data = resDatRandom, aes(x = as.numeric(score)), binwidth = 0.05, colour = "red")+
