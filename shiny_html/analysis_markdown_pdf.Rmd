...
if run_all == True:
  ...
  overlaps = pd.read_csv("/Users/thomasnicholson/phd/RNASeq/srna_seqs/version_1/predicted/overlaps_data.csv",
...
if run_all == True:
    ...
    representative_ids.to_csv('/Users/thomasnicholson/phd/RNASeq/srna_seqs/version_1/predicted/representative_ids.csv', index=False)
    ...
    file = open('/Users/thomasnicholson/phd/RNASeq/python_files/combined_d.json', 'w')
    ...
    representative_ids = pd.read_csv('/Users/thomasnicholson/phd/RNASeq/srna_seqs/version_1/predicted/representative_ids.csv')
    overlap_values_3 = pd.read_csv('/Users/thomasnicholson/phd/RNASeq/srna_seqs/version_1/predicted/overlap_values_3.csv')    
    
    with open('/Users/thomasnicholson/phd/RNASeq/python_files/combined_d.json', 'r') as read_file:
        combined_d = json.load(read_file)      
```

```{r combine_models, eval=F, include=F}
...
```{r combine_models_old, eval = F, include=F}
