...
outfile = open('/Users/thomasnicholson/phd/RNASeq/python_files/ids_and_overlaps.csv', 'a')
...
json_file <- "~/phd/RNASeq/python_files/combined_d.json"
...
oriDat <- read.table("~/phd/RNASeq/srna_seqs/version_1/predicted/original_stats_3.txt", sep = "", comment.char = "#", as.is = T, header = F, fill = T)
oriDat <- oriDat %>% filter(V3 != "")
colnames(oriDat) <- c("ori.descr", "ori.value", "ori.file")

newDat <- read.table("~/phd/RNASeq/srna_seqs/version_1/predicted/new_stats_3.txt", sep = "", comment.char = "#", as.is = T, header = F, fill = T)
