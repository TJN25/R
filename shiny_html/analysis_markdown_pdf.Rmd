...
```{r large_tree, eval=F}
  ...
  tree <- read.tree("~/bin/r_git/R/r_files/subset_taxa.tree")
tree
  p <-ggtree(tree) + 
  geom_tiplab(align = T) 
  p
  ggsave(filename = "~/phd/RNASeq/figures/subset_genus_tree_large.svg", device = 'svg', width = 50, height = 50, limitsize = FALSE)
```
