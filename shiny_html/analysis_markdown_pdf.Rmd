...
-   [*fix_peak_calling*](#section-fix_peak_calling)

-   [*Summary of Output Data*](#section-summary_of_output_data)
...
-   [*Section*](#section-predicting_srnas)
...
###Summary of Output Data {#summary_of_output_data}
...
[*Back to top (section)*](#section-get_srnas)
...
## Search for known ncRNAs and get phylogenetic distance matrix {#known_srna}

Go to:

-   [*Top*](#top)

-   [*Run over subset of genomes for all genera*](#section-subest_of_all_genomes)

-   [*run_csmscan_across_multiple_files*](#section-run_csmscan_across_multiple_files)

-   [*genome_contig_pairs*](#section-genome_contig_pairs)
