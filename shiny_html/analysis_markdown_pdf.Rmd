...
not beingt used
###get_genome_names
```{bash get_genome_names, eval=F}
#done in /representative_genomes/
> ../genome_accession_names.txt;
for file in GC*.fna; 
do  
  ...
  grep ^">" $file | sed 's/>//' | sed -e "s/$/   $ID/" >> ../genome_accession_names.txt;
